 ...
 * Un precio para adultos mayores de USD 20 para personas de 61 años o más (asumimos que la edad
 * máxima de un espectador es de 100 años)
...
fun ticketPrice(age: Int, isMonday: Boolean): Int {
    val entradaInfantil: Int = 15
    val entradaEstandar: Int = 30
    val entradaAdultosMayores: Int = 20
    val valorConDecuento: Int = 25

    return when (age) {
        in 0..12 -> entradaInfantil
        in 13..60 -> if (isMonday) valorConDecuento else entradaEstandar
        in 61..100 -> entradaAdultosMayores
        else -> -1
    }
